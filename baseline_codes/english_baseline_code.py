...
if __name__ == "__main__":
    ...
    image_directory = "MAMI"  # folder with meme images
    language = "english"  # set according to your dataset language
    country = "China"  # change the target culture as needed: "India", "China"
